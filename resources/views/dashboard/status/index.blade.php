...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Table Data Status</h1>
  </div>
...
<div class="container">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h1 class="modal-title fs-5" id="staticBackdropLabel">Input Data Status</h1>
  ...
  <div class="table-responsive col-lg-12">
    ...
    {{-- <a href="/dashboard/statusas/create" class="btn btn-primary mb-3">Create Status</a> --}}
    <table class="table table-striped table-sm">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>{{ $statusa->name }}</td>
          <td>
          <a href="/dashboard/statusas/{{ $statusa->id }}/edit" class="badge bg-warning">
            <span data-feather="edit"></span></a>

            <form action="/dashboard/statusas/{{  $statusa->id  }}" method="post" class="d-inline">
            @method('delete')
            @csrf
